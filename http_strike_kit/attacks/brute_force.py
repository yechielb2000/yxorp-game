...
def _send_get_request(base_url: str, path: str):
...
def brute_force_attack(base_url: str, wordlist_path: str, workers: int = 100):
    ...
    for path in paths:
        executor.submit(_send_get_request, base_url, path)
